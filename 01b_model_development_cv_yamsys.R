...
saveRDS(pls_Fe_total, "models/rep_kfold_cv/pls_Fe_total.Rds")
saveRDS(pls_Si_total, "models/rep_kfold_cv/pls_Si_total.Rds")
saveRDS(pls_Al_total, "models/rep_kfold_cv/pls_Al_total.Rds")
saveRDS(pls_K_total, "models/rep_kfold_cv/pls_K_total.Rds")
saveRDS(pls_Ca_total, "models/rep_kfold_cv/pls_Ca_total.Rds")
saveRDS(pls_Zn_total, "models/rep_kfold_cv/pls_Zn_total.Rds")
saveRDS(pls_Cu_total, "models/rep_kfold_cv/pls_Cu_total.Rds")
saveRDS(pls_Mn_total, "models/rep_kfold_cv/pls_Mn_total.Rds")
...
saveRDS(pls_pH, "models/rep_kfold_cv/pls_pH.Rds")
saveRDS(pls_exch_K, "models/rep_kfold_cv/pls_exch_K.Rds")
saveRDS(pls_exch_Ca, "models/rep_kfold_cv/pls_exch_Ca.Rds")
saveRDS(pls_exch_Mg, "models/rep_kfold_cv/pls_exch_Mg.Rds")
saveRDS(pls_exch_Al, "models/rep_kfold_cv/pls_exch_Al.Rds")
saveRDS(pls_CEC, "models/rep_kfold_cv/pls_CEC.Rds")
saveRDS(pls_BS, "models/rep_kfold_cv/pls_BS.Rds")
...
saveRDS(pls_N, "models/rep_kfold_cv/pls_N.Rds")
saveRDS(pls_C, "models/rep_kfold_cv/pls_C.Rds")
saveRDS(pls_S, "models/rep_kfold_cv/pls_S.Rds")
saveRDS(pls_P, "models/rep_kfold_cv/pls_P.Rds")
...
saveRDS(pls_resin_P_log, "models/rep_kfold_cv/pls_resin_P_log.Rds")
saveRDS(pls_Fe_DTPA_log, "models/rep_kfold_cv/pls_Fe_DTPA_log.Rds")
saveRDS(pls_Zn_DTPA, "models/rep_kfold_cv/pls_Zn_DTPA.Rds")
saveRDS(pls_Cu_DTPA, "models/rep_kfold_cv/pls_Cu_DTPA.Rds")
saveRDS(pls_Mn_DTPA, "models/rep_kfold_cv/pls_Mn_DTPA.Rds")

## =============================================================================
## 5: Texture: Sand, clay, and silt percentage
## =============================================================================

saveRDS(pls_sand, "models/rep_kfold_cv/pls_sand.Rds")
saveRDS(pls_sand_msc, "models/rep_kfold_cv/pls_sand_msc.Rds")
saveRDS(pls_silt, "models/rep_kfold_cv/pls_silt.Rds")
