...
## Date: July 25, 2017
## Project: YAMSYS
## Description: Plot model evaluation graphs for PLS regression calibration 
## models (5 times repeated 10-fold cross-validation) for the YAMSYS
## pilot sites
################################################################################
...
pls_Fe_total <- readRDS("models/rep_kfold_cv/pls_Fe_total.Rds")
pls_Si_total <- readRDS("models/rep_kfold_cv/pls_Si_total.Rds")
pls_Al_total <- readRDS("models/rep_kfold_cv/pls_Al_total.Rds")
pls_K_total <- readRDS("models/rep_kfold_cv/pls_K_total.Rds")
pls_Ca_total <- readRDS("models/rep_kfold_cv/pls_Ca_total.Rds")
pls_Zn_total <- readRDS("models/rep_kfold_cv/pls_Zn_total.Rds")
pls_Cu_total <- readRDS("models/rep_kfold_cv/pls_Cu_total.Rds")
pls_Mn_total <- readRDS("models/rep_kfold_cv/pls_Mn_total.Rds")
...
pls_pH <- readRDS("models/rep_kfold_cv/pls_pH.Rds")
pls_exch_K <- readRDS("models/rep_kfold_cv/pls_exch_K.Rds")
pls_exch_Ca <- readRDS("models/rep_kfold_cv/pls_exch_Ca.Rds")
pls_exch_Mg <- readRDS("models/rep_kfold_cv/pls_exch_Mg.Rds")
pls_exch_Al <- readRDS("models/rep_kfold_cv/pls_exch_Al.Rds")
pls_CEC <- readRDS("models/rep_kfold_cv/pls_CEC.Rds")
pls_BS <- readRDS("models/rep_kfold_cv/pls_BS.Rds")
...
pls_C <- readRDS("models/rep_kfold_cv/pls_C.Rds")
pls_N <- readRDS("models/rep_kfold_cv/pls_N.Rds")
pls_S <- readRDS("models/rep_kfold_cv/pls_S.Rds")
pls_P <- readRDS("models/rep_kfold_cv/pls_P.Rds")
...
pls_resin_P_log <- readRDS("models/rep_kfold_cv/pls_resin_P_log.Rds")
pls_Fe_DTPA_log <- readRDS("models/rep_kfold_cv/pls_Fe_DTPA_log.Rds")
pls_Zn_DTPA <- readRDS("models/rep_kfold_cv/pls_Zn_DTPA.Rds")
pls_Cu_DTPA <- readRDS("models/rep_kfold_cv/pls_Cu_DTPA.Rds")
pls_Mn_DTPA <- readRDS("models/rep_kfold_cv/pls_Mn_DTPA.Rds")

## =============================================================================
## 5: Texture: 
## Sand, silt and clay
## =============================================================================
pls_sand <- readRDS("models/rep_kfold_cv/pls_sand.Rds")
pls_sand_msc <- readRDS("models/rep_kfold_cv/pls_sand_msc.Rds")
pls_silt <- readRDS("models/rep_kfold_cv/pls_silt.Rds")
pls_clay <- readRDS("models/rep_kfold_cv/pls_clay.Rds")
...
extract_pls_plot <- function(list_in) {
  lapply(list_in, function(x) x$p_model)
}
...
models_texture <- c(
  "pls_sand", "pls_silt", "pls_clay"
)
models_sand <- c(
  "pls_sand", "pls_sand_msc"
)
...
models_all <- c(
  ...
  "pls_Zn_total", "pls_Cu_total", "pls_Mn_total", 
  "pls_pH", "pls_exch_K", "pls_exch_Ca", "pls_exch_Mg", "pls_exch_Al",
  "pls_CEC", "pls_BS", "pls_C", "pls_N", "pls_S", "pls_P",
  "pls_resin_P_log", "pls_Fe_DTPA_log", "pls_Zn_DTPA", "pls_Cu_DTPA",
  "pls_Mn_DTPA",
  "pls_sand", "pls_silt", "pls_clay"
)
...
grob_list_all <- lapply(
  list_pls_plot[models_all], ggplotGrob
)
...
pdf(file = "out/figs/rep_kfold_cv/poster_models_soil.pdf",
  width = 7, height = 5)
...
# Mineralogy
pdf(file = "out/figs/rep_kfold_cv/models_mineralogy.pdf",
  width = 7, height = 10)
...
pdf(file = "out/figs/rep_kfold_cv/models_mineralogy_nutrition.pdf",
  width = 7, height = 10)
...
# Organic matter
pdf(file = "out/figs/rep_kfold_cv/models_organic.pdf",
  width = 7, height = 5)
...
# Nutrition
# Organic matter
pdf(file = "out/figs/rep_kfold_cv/models_nutrition.pdf",
  width = 7, height = 8)
...
pdf(file = "out/figs/rep_kfold_cv/models_texture.pdf",
  width = 10, height = 6.5)
...
pdf(file = "out/figs/rep_kfold_cv/models_sand.pdf",
  width = 10, height = 6.5)
...
# All models compbined
pdf("out/figs/rep_kfold_cv/models_all.pdf", width = 25, height = 45)
gtable_arrange(ncol = 3, grobs = grob_list_all)
dev.off()
